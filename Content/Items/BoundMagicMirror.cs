    ...
    public class BoundMagicMirror : ModItem
    {
        ...
        public override void UseStyle(Player player, Rectangle heldItemFrame)
        {
            ...
            if (Main.rand.NextBool())
                Dust.NewDust(player.position, player.width, player.height, 15, 0f, 0f, 150, ParticleColor, 1.1f); // Makes dust from the player's position and copies the hitbox of which the dust may spawn. Change these arguments if needed.
