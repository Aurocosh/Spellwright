...
{
    internal abstract class MinionSummonSpell : Spell
    {
        ...
        public MinionSummonSpell(string name, string incantation, SpellType spellType = SpellType.Invocation) : base(name, incantation, spellType)
        {
            damage = 0;
            knockback = 0;
            canAutoReuse = false;
